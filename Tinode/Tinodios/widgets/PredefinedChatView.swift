...
class PredefinedChatView: UIView {
    ...
    let arrowDown = UIImage(named: "ic-chevron-down", in: .main, with: .none)
    let arrowUp = UIImage(named: "ic-chevron-up", in: .main, with: .none)
    ...
    private func configure() {
        ...
        titleLabel.text = "predefined_chat_title"
        firstLabel.text = "predefined_chat_1"
        secondLabel.text = "predefined_chat_2"
        thirdLabel.text = "predefined_chat_3"
