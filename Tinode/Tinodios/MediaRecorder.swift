...
public class MediaRecorder: NSObject {
    ...
    private func showPermissionAlert() {
        ...
        let alert = UIAlertController(
            title: "birdtalk_miscropone_title",
            message: "birdtalk_miscropone_desc",
            preferredStyle: .alert
        )

        alert.addAction(UIAlertAction(title: "birdtalk_miscropone_cancel", style: .cancel, handler: nil))
        alert.addAction(UIAlertAction(title: "birdtalk_miscropone_open_setting", style: .default, handler: { _ in
