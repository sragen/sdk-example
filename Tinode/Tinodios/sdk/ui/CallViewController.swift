...
class CallViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if self.isAudioOnlyCall {
            ...
            self.videoToggleButton.setImage(UIImage(named: "vc.slash.fill", in: .main, with: UIImage.SymbolConfiguration(pointSize: 16, weight: .regular)), for: .normal)
    ...
    @IBAction func didToggleCamera(_ sender: Any) {
        let newimg = UIImage(named: cameraManager.isCapturing ? "vc.slash.fill" : "vc.fill", in: .main, with: UIImage.SymbolConfiguration(pointSize: 16, weight: .regular))
